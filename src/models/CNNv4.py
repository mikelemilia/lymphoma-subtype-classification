...
class CNNv4(NeuralNetwork):
    ...
    def build(self, hidden_units: list):
        ...
        d = Conv2D(filters=256, kernel_size=(3, 3), strides=(1, 1), data_format='channels_last', activation='relu',
                   padding='same', name='C256')(c)
        d = MaxPooling2D(pool_size=2, name='MP256')(d)
